...
#define SAFE_RANGE (KC_EXSEL+1)

#define LCTL(kc) (KC_LCTL | (kc))
#define LSFT(kc) (KC_LSFT | (kc))
#define LALT(kc) (KC_LALT | (kc))
#define LGUI(kc) (KC_LGUI | (kc))
#define LCMD(kc) LGUI(kc)
#define LWIN(kc) LGUI(kc)
#define RCTL(kc) (KC_RCTL | (kc))
#define RSFT(kc) (KC_RSFT | (kc))
#define RALT(kc) (KC_RALT | (kc))
#define ALGR(kc) RALT(kc)
#define RGUI(kc) (KC_RGUI | (kc))
